...
class CollisionGroups {
    ...
    get(sourceID: string) {
        ...
        if (!this.crossSourceCollisions || (typeof this.crossSourceCollisions === 'object' && (this.crossSourceCollisions: Object)[sourceID] === false)) {
            ...
            return { ID: 0, predicate: (key) => key.collisionGroupID === 0 };
        } else {
